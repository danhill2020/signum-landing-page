          ...
          <div className="grid xl:grid-cols-2 items-center gap-10">
            ...
            <div className="order-first xl:order-last xl:justify-self-end">
              <div
                ...
                aspect-[4/3]
                rounded-2xl bg-night-2/95 ring-1 ring-white/10
              ...
              >
                <div className="flex items-center gap-4 sm:gap-5">
                  <div className="rounded-xl bg-white/5 p-4 ring-1 ring-white/10">
                    <QrCode className="h-8 w-8 text-ink-100-100" />
                  </div>
                  <div className="space-y-1.5">
                    <div className="h-2.5 w-28 rounded bg-night-3" />
                    <div className="h-2.5 w-36 rounded bg-night-3" />
                    <div className="h-2.5 w-20 rounded bg-night-3" />
                  </div>
                </div>
              </div>
            </div>
...
function WaysToAccept() {
  ...
  return (
    <section id="ways">
      ...
      <p className="mt-2 text-ink-100-300 pr-6">
      ...
      <div className="mt-6 grid lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {cards.map((c) => (
          <article key={c.title} className="card p-6">
            ...
            <h3 className="mt-3 font-semibold text-ink-100-100">{c.title}</h3>
...
function PaymentTypes() {
  ...
  return (
    <section id="types">
      <h2 className="text-2xl font-semibold text-ink-100-100">Payment types</h2>
      ...
      <div className="mt-6 grid lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {cards.map((c) => (
          <article
            key={c.title}
            className="relative rounded-2xl bg-night-2 p-6 ring-1 ring-neutral-200/70 shadow-[var(--shadow-card)]"
          >
            {c.image && (
              <img
                src={c.image}
            ...
            {c.eyebrow && (
              <div className="text-[12px] font-semibold uppercase tracking-wide text-ink-100-300">
                {c.eyebrow}
              </div>
            )}

            <h3 className="mt-1 text-xl font-semibold text-ink-100-100">
              {c.title}
            </h3>
            ...
            {c.bullets?.length ? (
              <ul className="mt-3 space-y-2 text-[15px] text-ink-100-100">
                {c.bullets.map((b) => (
    ...
    <section id="subscription">
      ...
      <div className="mt-6 card p-6">
        ...
        <div className="flex items-start gap-3">
          <div className="shrink-0 rounded-xl bg-white/5 p-2 text-ink-100-100/80">
            <Repeat className="h-5 w-5" />
          </div>
          <h3 className="font-semibold text-ink-100-100">Why it’s different</h3>
        </div>
...
function Cashback() {
  return (
    <section id="cashback">
      ...
      <div className="mt-6 card p-6">
        <h3 className="font-semibold text-ink-100-100">How to activate</h3>
        <ol className="mt-2 list-decimal pl-5 space-y-1 text-[15px] text-ink-100-300">
    ...
    <section id="dev">
      ...
      <div className="mt-6 grid xl:grid-cols-2 gap-6">
        <article className="card p-6">
          <h3 className="font-semibold text-ink-100-100">SignumJS</h3>
          <p className="mt-2 text-[15px] text-ink-100-300">
    ...
    <section id="faq">
      ...
      <div className="mt-6 grid gap-4">
        {items.map((f) => (
          <details
            key={f.q}
            className="rounded-xl border border-white/10 bg-night-2/80 p-4"
          >
            <summary className="cursor-pointer font-semibold text-ink-100-100">
              {f.q}
            </summary>
            <p className="mt-2 text-[15px] text-ink-100-300">{f.a}</p>
          </details>
        ))}
      </div>
    </section>
...
function QRDemo() {
  return (
    <section id="QR" className="bg-night-2">
      <div className="mt-6 card p-6">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="sm:col-span-1">
            <label className="block text-sm font-medium text-ink-100-100">
              Amount (SIGNA)
            </label>
            <input
              className="mt-1 w-full rounded-xl border border-white/10 px-3 py-2"
              placeholder="10"
            />
          </div>
        ...
        <p className="mt-3 text-xs text-ink-100-400">
